...
function Postdetails() {
  return (
    ...
    //         <h1 className='text-2xl font-bold text-black md:text-3xl'>adipisicing elit. Incidunt, consequuntur.</h1>
    ...
    //         <p>16:45</p>
    //     </div>
    //     <img src={data} alt="" className='w-5xl mx-auto mt-8'/>
    // </div>
      ...
      <div className="flex flex-col md:flex-row gap-5 shadow-md hover:shadow-lg transition-shadow rounded-lg p-4">
        ...
        <div className="flex flex-col w-full md:w-[65%] px-1">
          <div className='flex items-center justify-between '>
            ...
            <div className='flex items-center justify-center gap-5 text-xl md:text-2xl'>
                 <p><MdDeleteForever /></p>
                 <p><CiEdit /></p>
            </div>
          </div>
